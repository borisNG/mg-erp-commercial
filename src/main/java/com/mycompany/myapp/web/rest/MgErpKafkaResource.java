...
@RestController
@RequestMapping("/api/mg-erp-kafka")
public class MgErpKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private final Logger log = LoggerFactory.getLogger(MgErpKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public MgErpKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
